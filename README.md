...
# cov_matrix_df.head()
```
An alternative co-variance matrix by [Ledoit-Wolf shrinkage](http://www.ledoit.net/Review_Paper_2020_JFEc.pdf) should supposedly return a better estimation. 
